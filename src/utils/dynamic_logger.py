...
class Logger:
    ...
    def __init__(self, tar_file: str="default.log", tar_dir="data"):
        ...
        self.log_fp = Path().resolve().joinpath(self.tar_dir).joinpath(self.tar_file)
    ...
    def set_file_handler(self):
        ...
        self.current_handler = logging.FileHandler(self.log_fp.as_posix())
        ...
        self.log.info(f"Added new handler: {self.log_fp}")
